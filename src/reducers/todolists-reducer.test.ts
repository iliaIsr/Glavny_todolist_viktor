import {
    AddTodolistActilonType, ChangeTodolistFilterActionType,
    ChangeTodolistTitleActilonType,
...
test('correct todolist should be added', () => {
    ...
    const action: AddTodolistActilonType = {
        type: 'ADD-TODOLIST',
        payload: {
            title: 'New Todolist',
            todolistId: v1()
...
test('correct todolist should change its name', () => {
    ...
    const action:ChangeTodolistTitleActilonType = {
